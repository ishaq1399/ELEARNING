...
switch($_GET[act]){
  ...
  default:
    ...
    $tampil=mysqli_query($db,"SELECT * FROM templates ORDER BY id_templates DESC LIMIT $posisi,$batas");
    ...
    echo "</table>";
    $jmldata=mysqli_num_rows(mysqli_query($db,"SELECT * FROM templates"));
  ...
  // Form Edit Templates 
  case "edittemplates":
    $edit=mysqli_query($db,"SELECT * FROM templates WHERE id_templates='$_GET[id]'");
